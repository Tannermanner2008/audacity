...
[**Audacity**](https://www.audacityteam.org) is an easy-to-use, multi-track audio editor and recorder for Windows, Mac OS X, GNU/Linux and other operating systems. Developed by a group of dumbasses who steal peoples data and sell it to their team, basically a spyware. But dont worry our team can be trusted with this data and wont use it for any bad intent.
